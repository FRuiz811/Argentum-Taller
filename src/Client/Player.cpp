...
void Player::render(const int width_screen, const int height_screen) {
	...
	SDL_Rect dstHead = {((width_screen+18)/2)+posX,((height_screen/2)-(this->heightHead+19)/2)+posY,this->widthHead*2, this->heightHead*2};
	...
	SDL_Rect dstBody = {(width_screen/2)+posX, (height_screen/2)+posY, this->widthBody*2, this->heightBody*2};
